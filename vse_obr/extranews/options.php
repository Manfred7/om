...
$options[] = array( "name" => __("Default Croping of Slideshow Images", "framework"),
                    "desc" => "Select if you want all the images to have the same height. This can be adjusted on individual post pages, too.",
                    "id" => $shortname."_slide_crop_images",
                    "std" => "yes",
                    "type" => "select",
                    "options" =>  array(
                        'yes' => 'Crop',
...
$options[] = array( "name" => __("Default Slideshow Autoplay", "framework"),
                    "desc" => "Select if you want your slideshow to automatically play. This can be adjusted on individual post pages, too.",
                    "id" => $shortname."_auto_play_slideshow",
                    "std" => "Yes",
                    "type" => "select",
                    "options" =>  array(
                        'yes' => 'Autoplay',
...
$options[] = array( "name" => __("Default Share Style", "framework"),
                    "desc" => "Select a sharing section style for your post. This can be adjusted on individual post pages, too.",
                    "id" => $shortname."_share_style",
                    "std" => "minimal",
                    "type" => "select",
                    "options" =>  array(
                        'minimal' => 'Minimal',
...
$options[] = array( "name" => __("Default Author Style", "framework"),
                    "desc" => "What style do you want the author information? This can be adjusted on individual post pages, too.",
