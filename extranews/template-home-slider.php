            ...
            <div class="homepageslideshow featuredimage">
                <div class="slider-wrapper theme-default">
                    <div class="slider nivoSlider">
						...
						<?php if ($image) { ?>
                                <a href="<?php the_permalink();?>"><img src="<?php echo $image[0] ?>" title="&lt;a href='<?php the_permalink();?>'&gt; &lt;h3 class='title' &gt;<?php the_title(); ?>&lt;/h3&gt; &lt;p&gt;<?php global $more; $more=0; echo htmlspecialchars (get_the_content_unformatted($post->post_content)); ?>&lt;/p&gt;&lt;/a&gt;"></a>
                        <?php } ?>
