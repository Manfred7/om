...
function optionsframework_page() {
   ...
   <h2 class="themeoptions"> Theme Options</h2>
		<div class="extern-links">
			...
			<a class="icon-a icon-documentation" href='<?php echo get_template_directory_uri()?>/pdf/documentation.pdf' target="_blank" ><span class="icon"><span>Documentation</span></span></a>
		</div>
		<br class="clear" />
    ...
    <div id="optionsframework" class="postbox">
		...
		<div id="optionsframework-submit">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'framework' ) ); ?>' );" />
            <div class="clear"></div>
		</div>
