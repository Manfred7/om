...
/*----------------------------------------------------------*/
	...
	function __construct() {
		...
		/* Create widget */
		parent::__construct( 'ag_tab_widget', __('Custom Posts and Facebook Tab Widget', 'framework'), $widget_ops, $control_ops );
	}
...
<ul class="tabs <?php echo $twocol; ?>">
	...
	<?php if ($social == 'facebook') {  ?> <li><a href="#tab3"><?php _e('Facebook', 'framework')?></a></li> <?php } ?>
</ul>	
<div class="clear"></div>
